...
// Sends plans to GPT-4o and Gemini Flash for structured review across
// 5 dimensions, then deduplicates and ranks feedback.
...
if (available.length === 0) {
  console.error(
    "Warning: No API keys configured. Set OPENAI_API_KEY or GOOGLE_AI_API_KEY.",
  );
} else {
  console.error(
