...
class TransformerBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor, gate_signals: Optional[torch.Tensor] = None):
        seq_len = x.size(1)
...
class TransformerLM(nn.Module):
    ...
    def forward(
        ...
        Returns:
            ...
            viz_data: Dict with optional hidden_states
        """
        ...
        for block in self.transformer_blocks:
            hidden_states = block(hidden_states, gate_signals)
